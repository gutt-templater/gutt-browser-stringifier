...
describe ('JS array functions', function () {
  it ('arr_keys', function () {
    ...
    return parse(template, {a: 4, b: 5}).should.eventually.deep.equal(result)
  })
  ...
  it ('arr_contain positive', function () {
    ...
    return parse(template).should.eventually.deep.equal(['found'])
  })
  ...
  it ('arr_contain negative', function () {
    ...
    return parse(template).should.eventually.deep.equal([])
  })
  ...
  it ('arr_rand', function () {
    ...
    return parse(template).should.eventually.deep.equal(['contain'])
  })
